## https://github.com/pnbruckner/homeassistant-config/blob/53fe1dff32a36a84a4efdbb87b72387d4ce5f091/python_scripts/light_store.py
#
#VERSION = '1.2.0'
#
#DOMAIN = 'light_store'
...
#                    logger.error(
#                        f'Could not get state of {entity_id}.',
#                    )
#                else:
#                    attributes = {}
...
#                logger.error(f'No saved state for {entity_id}.')
#            else:
...
#                hass.services.call(
#                    component, 'turn_on' if turn_on else 'turn_off', service_data,
#                )
#
